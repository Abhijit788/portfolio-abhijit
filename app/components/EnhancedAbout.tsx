...
export default function EnhancedAbout() {
  ...
  return (
    <section id="about" className="relative min-h-screen flex flex-col justify-center py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-4xl relative z-10 text-center mb-20">
        <AnimateOnScroll animation="fadeIn">
          <div className="space-y-8">
            {/* Main Brand Identity */}
            <div className="space-y-6">
              <div className="flex items-center justify-center">
                <div className="ide-window p-4 relative overflow-hidden mr-6">
                  <Terminal className="h-10 w-10 text-blue-400 relative z-10" />
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-purple-500/20 animate-pulse"></div>
                </div>
                <div className="text-left">
                  <h1 className="text-5xl md:text-7xl font-bold syntax-function mb-2">
                    <TypewriterText text="abhijit.dev" speed={120} />
                  </h1>
                  <div className="text-xl md:text-2xl syntax-comment">
                    <TypewriterText
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                ...
                <div className="text-lg syntax-comment">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-8">
              {[
                { name: "About Me", path: "about", color: "syntax-keyword" },
                { name: "Projects", path: "projects", color: "syntax-function" },
                { name: "Blog Posts", path: "blog", color: "syntax-string" },
                { name: "Social", path: "contact", color: "syntax-variable" },
              ].map((item) => (
                <a
                  key={item.name}
                  href={`#${item.path}`}
                  className={`code-button px-8 py-4 text-lg ${item.color} hover-highlight group relative overflow-hidden transition-all duration-300 hover:scale-105`}
                >
                ...
                <div className="flex-1 flex">
                  {tabs.map((tab) => (
                    <button
                      ...
                      className={`ide-tab flex items-center space-x-2 ${activeTab === tab.id ? "active" : ""}`}
                    >
              ...
              <div className="p-6 space-y-6">
                  ...
                  <div className="space-y-6 animate-in fade-in duration-500">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="p-4 bg-black/30 rounded border border-gray-700">
                        <TypewriterText text={bioText} speed={20} className="text-sm syntax-string leading-relaxed" />
                      </div>
                    </div>
                  </div>
                )}
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      {socialLinks.map(({ icon: Icon, href, label, color, description }) => (
                        ...
                        >
                          ...
                          <span className="text-xs opacity-50 relative z-10">→</span>
                        </a>
                      ))}
                    </div>
                  </div>
                ...
                <div className="pt-4 border-t border-gray-700">
                  ...
                  >
                    ...
                    <span className="relative z-10">downloadResume()</span>
                  </a>
                </div>
              </div>
            </div>
          ...
          <AnimateOnScroll animation="fadeIn" className="order-1 lg:order-2">
            <div className="space-y-6">
              ...
              <div className="console-window">
                <div className="console-header flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="status-indicator">
                      ...
                      <span>{isRunning ? "Initializing" : "Ready"}</span>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                ...
                <div className="console-content min-h-[400px]">
                  {consoleLines.map((line, index) => (
                    <div key={index} className="console-line animate-in fade-in duration-200">
                      {line.startsWith("$") ? (
                ...
                <div className="debug-content">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="debug-line">
                      <span className="debug-level info">[UPTIME]</span>
                      <span>{systemStats.uptime}</span>
                    </div>
                    <div className="debug-line">
                      <span className="debug-level info">[PROC]</span>
                      <span>{systemStats.processes}</span>
                    </div>
                    <div className="debug-line">
                      <span className="debug-level info">[MEM]</span>
                      <span>{systemStats.memory}</span>
                    </div>
                    <div className="debug-line">
                      <span className="debug-level info">[NET]</span>
